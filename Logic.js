...
// let itrate=arr.entries();
// console.log(itrate.next().value);
// console.log(itrate.next().value);
// console.log(itrate.next().value);
// console.log(itrate.next().value);
// console.log(itrate.next().value);
...
// let c=arr.every((ele)=>ele<10)
// console.log(c);

// let a=arr.fill(0,3,5)
// console.log(a);

// let b=arr.filter((ele)=>ele>=2&&ele<=6)
// console.log(b);

// let e=arr.map((ele)=>ele/10)
// console.log(e);

// let h=arr.find((ele)=>ele==5)
// console.log(h);

let f=arr.findIndex((ele)=>ele==3)
console.log(f);

// console.log(arr.indexOf(5));


// let g=arr.findLast((ele)=>ele<5)
// console.log(g);
