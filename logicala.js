...
// const student=[
//   {
//     Name:'anuj', subject:'science',class:'10',marks:48},
//    { Name:'rajat', subject:'Math',marks:'40',class:10},
//     {Name:'lucky', subject:'Math',marks:'32',class:10
//   }
// ]
// function check() {
//   let result={};
//   let pass=student.filter((ele)=>ele.marks>33)

    
  
//   result.passlist=pass
//   result.passcount=pass.length
// let fail=student.filter((ele)=>ele.marks<33)
// result.failist=fail
// result.failcount=fail.length
// return result
// }
// console.log(check());

// function topper(marks) {
//   let large= 0;
...
// function balanceinquary(users) {           //question 2
  // console.log("total balance",users.reduce((acc,curv)=> acc+ curv.balance,0))
...
//   let check=[]
//   let result=users.some((item)=>item.age>25 )                   //question 6
//   if (result) {
...
// function time(time) {
//   let timea=setInterval(() => {              //question 2
//     let date=new Date()
